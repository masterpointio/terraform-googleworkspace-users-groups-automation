...
| <a name="input_groups"></a> [groups](#input\_groups) | List of groups | <pre>map(object({<br/>    name : string,<br/>    # description : optional(string),<br/>    email : string,<br/>    description : optional(string),<br/>    timeouts : optional(object({<br/>      create : optional(string),<br/>      update : optional(string),<br/>      }), {<br/>      create = null<br/>      update = null<br/>    }),<br/>  }))</pre> | `{}` | no |
